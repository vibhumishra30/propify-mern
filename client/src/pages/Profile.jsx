  ...
  return (
    <div className = ' max-w-lg mx-auto'>
      ...
      <form onSubmit = {handleSubmit} className = 'flex flex-col gap-4'>
        ...
        className = 'border p-2 rounded-lg' onChange = {handleChange} />
        ...
        <Link 
        className = "bg-green-700 text-white p-2 rounded-lg uppercase text-center hover:opacity-90" 
        to = {"/create-listing"}>
          Create Listing
        </Link>
      </form>
      ...
      <div className = "flex flex-col gap-4">
        <h1 className = "text-center text-2xl mt-5 font-semibold">Your Listings</h1>
